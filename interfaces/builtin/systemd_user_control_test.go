...
func (s *SystemdUserControlInterfaceSuite) TestUsedSecuritySystems(c *C) {
	...
	c.Assert(aasnippets.SnippetForTag("snap.other.app"), testutil.Contains, "bus=session")
	c.Assert(aasnippets.SnippetForTag("snap.other.app"), Not(testutil.Contains), "bus=system")
	c.Assert(aasnippets.SnippetForTag("snap.other.app"), testutil.Contains, "UpdateActivationEnvironment")
}
