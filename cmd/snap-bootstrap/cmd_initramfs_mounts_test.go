...
type initramfsMountsVeritySuite struct {
	initramfsMountsSuite
}

var _ = Suite(&initramfsMountsVeritySuite{})

func (s *initramfsMountsVeritySuite) SetUpTest(c *C) {
	s.hasVerity = true
	s.initramfsMountsSuite.SetUpTest(c)
}

func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeUnencryptedWithSaveHappy(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeWithBootedKernelPartUUIDHappy(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeUpgradeScenarios(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeUpdateBootloaderVars(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeTimeMovesForwardHappy(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeNoSaveUnencryptedKeyLockingUnhappy(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeNoSaveUnencryptedHappy(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeHappyNoSaveRealSystemdMount(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeHappyNoGadgetMount(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeFirstBootRecoverySystemSetHappy(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeEncryptedDataHappy(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeBootFlagsSet(c *C) {
	// TODO: implement run mode verity
}
func (s *initramfsMountsVeritySuite) TestInitramfsMountsRunModeWithSaveHappyRealSystemdMount(c *C) {
	// TODO: implement run mode verity
}
