...
`
	...
	ctlcmd.MockRegistryTransaction(func(ctx *hookstate.Context, reg *registry.Registry) (*registrystate.Transaction, error) {
		txVal := ctx.Cached("tx")
		if txVal != nil {
			return txVal.(*registrystate.Transaction), nil
		}
