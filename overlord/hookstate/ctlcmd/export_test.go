...
func MockRegistryTransaction(f func(ctx *hookstate.Context, reg *registry.Registry) (*registrystate.Transaction, error)) (restore func()) {
	restore = testutil.Backup(&registrystateRegistryTransaction)
